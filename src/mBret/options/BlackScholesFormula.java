...
public class BlackScholesFormula {
	...
	public static double calculate(boolean callOption, double s, double k, double r, double t, double v) {
		...
		// System.out.println(" ----- ");
		// System.out.println(" in BlackScholesFormula:calculate(" + callOption + "," +
		// s + "," + k + "," + r + "," + t + "," + v);
		...
		System.out.println(
				"  callOption-" + callOption + ", spot-" + s + ", strike-" + k + ", r-" + r + ", T-" + t + ", v-" + v);
	...
	public static double calculate(OptionDetails req) {
		...
		response = calculate(req.callOption, req.spotPriceOfUnderlying, req.strikePrice, req.riskFreeInterestRate,
				req.timeToExpire, req.volatility);

		return response;
	}

	public void calculateWithGreeks(boolean callOption, double s, double k, double r, double t, double v) {
	...
	public static OptionDetails calculateWithGreeks(OptionDetails req) {
		...
		price = calculate(req.callOption, req.spotPriceOfUnderlying, req.strikePrice, req.riskFreeInterestRate,
				req.timeToExpire, req.volatility);
